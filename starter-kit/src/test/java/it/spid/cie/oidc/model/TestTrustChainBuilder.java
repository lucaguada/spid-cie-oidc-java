...
public class TestTrustChainBuilder {
  ...
  public void test_ApplyPolicy() {
    ...
    try {
      JSONObject metadata = new JSONObject()
        .put("test1", Json.array("0", "1"))
        .put("test2", Json.array("0", "1", "2", "3"));

      JSONObject policy = new JSONObject()
        .put("test1", new JSONObject().put("value", "value"))
        .put("test2", new JSONObject().put(
          "one_of", Json.array("1", "3")));
    ...
    try {
      JSONObject metadata = new JSONObject()
        .put("test1", "0")
        .put("test2", Json.array("0", "1", "2", "3"))
        .put("test3", Json.array("0", "1", "2", "3"))
        .put("test1b", "0")
        .put("test1c", Json.array("0", "1"))
        .put("test1d", Json.array("0", "1"));
      ...
      JSONObject policy = new JSONObject()
        ...
        .put("test1d", new JSONObject().put(
          "add", Json.array("2", "3")))
        .put("test2", new JSONObject().put(
          "superset_of", Json.array("3", "4", "5")))
        .put("test3", new JSONObject().put(
          "subset_of", Json.array("3", "4", "5")));
