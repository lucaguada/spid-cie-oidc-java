...
import it.spid.cie.oidc.util.Json;
...
public class RPTestUtils extends TestUtils {
  ...
  public static String mockedSPIDProviderEntityConfiguration() throws Exception {
    JSONObject payload = new JSONObject()
      ...
      .put("authority_hints", Json.array(TRUST_ANCHOR));
    ...
    JSONObject providerMetadata = new JSONObject()
      ...
      .put("contacts", Json.array("ops@https://idp.it"))
      .put("client_registration_types_supported", Json.array("automatic"))
      .put("code_challenge_methods_supported", Json.array("S256"))
      .put(
        "request_authentication_methods_supported",
        new JSONObject().put("ar", Json.array("request_object")))
      .put(
        "acr_values_supported", Json.array(
      ...
      .put(
        "claims_supported", Json.array(
          ...
          "address"))
      .put(
        "grant_types_supported", Json.array(
          "authorization_code", "refresh_token"))
      .put(
        "id_token_signing_alg_values_supported", Json.array(
          "RS256", "ES256"))
      .put("issuer", SPID_PROVIDER)
      .put("jwks", mockedSPIDProviderPublicJWKS())
      .put("scopes_supported", Json.array("openid", "offline_access"))
      ...
      .put("response_types_supported", Json.array("code"))
      .put("subject_types_supported", Json.array("pairwise", "public"))
      .put(
      ...
      .put(
        "userinfo_encryption_alg_values_supported", Json.array(
          "RSA-OAEP", "RSA-OAEP-256", "ECDH-ES", "ECDH-ES+A128KW",
          "ECDH-ES+A192KW", "ECDH-ES+A256KW"))
      .put(
        "userinfo_encryption_enc_values_supported", Json.array(
          "A128CBC-HS256", "A192CBC-HS384", "A256CBC-HS512", "A128GCM",
          "A192GCM", "A256GCM"))
      .put(
        "userinfo_signing_alg_values_supported", Json.array(
          "RS256", "RS384", "RS512", "ES256", "ES384", "ES512"))
      .put(
        "request_object_encryption_alg_values_supported", Json.array(
          "RSA-OAEP", "RSA-OAEP-256", "ECDH-ES", "ECDH-ES+A128KW",
          "ECDH-ES+A192KW", "ECDH-ES+A256KW"))
      .put(
        "request_object_encryption_enc_values_supported", Json.array(
          "A128CBC-HS256", "A192CBC-HS384", "A256CBC-HS512", "A128GCM",
          "A192GCM", "A256GCM"))
      .put("request_object_signing_alg_values_supported", Json.array(
        "RS256", "RS384", "RS512", "ES256", "ES384", "ES512"));
    ...
    JSONObject providerPolicy = new JSONObject()
      ...
      .put(
        "token_endpoint_auth_methods_supported", new JSONObject()
          .put("value", Json.array("private_key_jwt")))
      .put(
  ...
  public static String mockedTrustAnchorEntityConfiguration() throws Exception {
    ...
    JSONObject trustAnchorMetadata = new JSONObject()
      .put("contacts", Json.array("ta@localhost"))
    ...
    JSONObject trustMarkIssuers = new JSONObject()
      .put(
        "https://www.spid.gov.it/certification/rp/public", Json.array(
          TM_ISSUER1, TM_ISSUER2))
      .put(
        "https://www.spid.gov.it/certification/rp/private", Json.array(
          TM_ISSUER1, TM_ISSUER2))
      .put(
        "https://sgd.aa.it/onboarding", Json.array(
          TM_ISSUER1));
